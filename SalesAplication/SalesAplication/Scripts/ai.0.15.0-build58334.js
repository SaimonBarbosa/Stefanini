    ...
    (function (ApplicationInsights) {
        ...
        (function (Context) {
            ...
            var Operation = (function () {
                function Operation() {
                    this.id = ApplicationInsights.Util.newint();
                }
                return Operation;
            })();
        ...
        (function (Context) {
            ...
            var _SessionManager = (function () {
                ...
                _SessionManager.prototype.renew = function () {
                    var now = +new Date;
                    this.automaticSession.id = ApplicationInsights.Util.newint();
                ...
                _SessionManager.prototype.setCookie = function (int, acq, renewal) {
                    var acquisitionExpiry = acq + this.config.sessionExpirationMs();
                    var renewalExpiry = renewal + this.config.sessionRenewalMs();
                    var cookieExpiry = new Date();
                    var cookie = [int, acq, renewal];
                ...
                _SessionManager.prototype.setStorage = function (int, acq, renewal) {
                    ApplicationInsights.Util.setStorage('ai_session', [int, acq, renewal].join('|'));
                };
